...
if __name__ == "__main__":
    ...
    pd_file = "~/Desktop/PaddleMIX/paddlemix/models/vits-svc/data_svc/speaker/421_all/000003.spk.npy"
    pd_file = os.path.expanduser(pd_file)

    tc_file = "~/Desktop/whisper-vits-svc/data_svc/speaker/421_all/000003.spk.npy"
...
if __name__ == "__main__":
    ...
    # model
    args.model_path = os.path.join("speaker_pretrain", "best_model.pdparam")
    ...
    speaker_encoder.load_checkpoint(args.model_path, eval=True)
