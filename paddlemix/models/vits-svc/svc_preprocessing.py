...
assert paddle.device.cuda.device_count() >= 1, "\033[31m You need GPU to Train! \033[0m"
...
commands = [
   ...
   "python prepare/preprocess_speaker_ave.py --dataset_speaker data_svc/speaker/ --dataset_singer data_svc/singer",
